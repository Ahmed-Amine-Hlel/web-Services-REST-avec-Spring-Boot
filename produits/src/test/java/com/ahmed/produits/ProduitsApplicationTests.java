...
Produit prod = new Produit("PC Asus",2500.0,new Date());
...
{
List<Produit> prods=produitRepository.findByNomProduitContains("MS");
...
{
List<Produit> prods = produitRepository.findByNomPrix("PC MSI", 2200.5);
for (Produit p : prods)
{
System.out.println(p);
}
